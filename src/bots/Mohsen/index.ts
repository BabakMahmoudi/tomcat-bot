...
const halfTrend = tomcat.Domain.Indicators.HalfTrend(2, 2, 200, '30m')
const hTSignal = tomcat.Domain.Indicators.HTSignal(2, 2, 200, '30m')
const rsi = tomcat.Domain.Indicators.RSI(2, 200, '30m')
let signal = ""
let position = "sell"
